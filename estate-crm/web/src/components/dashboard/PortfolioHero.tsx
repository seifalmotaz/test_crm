...
export default function PortfolioHero({ value, returnPct, returnAbs, onRangeChange }: PortfolioHeroProps) {
  ...
  return (
    <div className="bg-card card-border rounded-2xl p-6 glow-blue h-full flex flex-col">
        ...
        <div className="flex gap-1.5 flex-shrink-0">
          {['6M', '1Y'].map(r => (
            <button
              ...
              style={{
                padding: '4px 12px',
                background: activeRange === r ? 'rgba(255,255,255,0.14)' : 'rgba(255,255,255,0.07)',
                border: '1px solid rgba(255,255,255,0.10)',
                color: activeRange === r ? '#ffffff' : 'rgba(255,255,255,0.45)',
              }}
            >
              {r}
            </button>
      ...
      >
        <p className="text-white font-bold leading-none mb-3" style={{ fontSize: 30, letterSpacing: '-0.02em' }}>
          {formattedValue}
        </p>
