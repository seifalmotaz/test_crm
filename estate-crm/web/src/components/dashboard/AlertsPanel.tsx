  ...
  return (
    <div className="bg-card card-border rounded-2xl p-5 glow-blue">
      <div className="flex items-center justify-between mb-4">
        ...
        <span className="text-[10px] px-2 py-0.5 rounded-full font-medium" style={{ background: 'rgba(192,128,144,0.12)', color: '#C08090' }}>
          {highCount} urgent
        </span>
      </div>
      <div className="space-y-2.5">
        {alerts.map((alert, i) => {
          ...
          return (
            <div key={i} className="flex items-start gap-3 p-3 rounded-xl border cursor-pointer hover:brightness-110 transition-all" style={bg}>
