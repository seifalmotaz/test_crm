...
export const ErrorCodes = {
  ...
  LEAD_ALREADY_CLIENT: 'LEAD_ALREADY_CLIENT',
  LEAD_DNC_ACTIVE: 'LEAD_DNC_ACTIVE',
  LEAD_TAG_DUPLICATE: 'LEAD_TAG_DUPLICATE',
  LEAD_TAG_NOT_FOUND: 'LEAD_TAG_NOT_FOUND',
  LEAD_NOT_ASSIGNED: 'LEAD_NOT_ASSIGNED',

  // Client
  CLIENT_NOT_FOUND: 'CLIENT_NOT_FOUND',
  CLIENT_NOT_A_CLIENT: 'CLIENT_NOT_A_CLIENT',

  // Deal
  DEAL_NOT_FOUND: 'DEAL_NOT_FOUND',
  DEAL_STAGE_INVALID: 'DEAL_STAGE_INVALID',
  DEAL_CLOSING_LOCKED: 'DEAL_CLOSING_LOCKED',
  DEAL_TAG_DUPLICATE: 'DEAL_TAG_DUPLICATE',
  DEAL_TAG_NOT_FOUND: 'DEAL_TAG_NOT_FOUND',
