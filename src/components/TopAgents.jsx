  ...
  return (
    <div className="bg-card card-border rounded-2xl p-5 glow-blue">
      <div className="flex items-center gap-2 mb-4">
        ...
        <p className="text-white font-semibold text-sm">{t('ui.topPerformers')}</p>
      </div>
        ...
        {agents.map((agent, i) => (
          <div key={agent.id} className="flex items-center gap-3 p-2.5 rounded-xl hover:bg-white/5 transition-colors group">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-slate-500 text-[10px]">{agent.region} · {agent.dealsThisMonth} {t('ui.dealsClosedLabel')}</p>
            </div>
